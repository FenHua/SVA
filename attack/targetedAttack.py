...
from attack.attack_utils import targeted_video_attack                # attack method


def attack(vid_model,vid,target_vid,target_label,mask_list,image_models,gpus):
    ...
    # Targeted attack
    directions_generator.set_targeted_params(target_vid.cuda(), random_mask)  # 初始扰动生成器参数设定（有目标）

    res, iter_num, adv_vid = targeted_video_attack(vid_model, vid, target_vid,target_label,directions_generator,
